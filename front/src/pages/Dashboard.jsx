...
const PIPELINE_STEPS = [
  { icon: "🧠", label: "Profile Intelligence", desc: "Resume + Skill Graph", path: "/profile", color: "#8b5cf6" },
  { icon: "🎯", label: "Tech Job Match",        desc: "Top 10 matched jobs",  path: "/jobs",    color: "#2dd4bf" },
    ...
    <div style={layout.page}>
      ...
      <main style={layout.main}>
        <div style={styles.loadingCenter}>
          ...
          <p style={{ color: "#9aa7c2", marginTop: 12 }}>Loading your career intelligence...</p>
        </div>
      </main>
    </div>
  );
    ...
    <div style={layout.page}>
      ...
      <main style={layout.main}>
        ...
        <div style={styles.metricsGrid}>
          ...
          <div style={{ ...styles.metricCard, border: `1px solid ${readinessColor}30` }}>
            ...
            <div style={styles.metricRow}>
              <svg width={72} height={72} viewBox="0 0 72 72">
                <circle cx="36" cy="36" r="30" fill="none" stroke="#101728" strokeWidth="8" />
                <circle
                  cx="36" cy="36" r="30"
                  fill="none"
                ...
                />
                <text x="36" y="41" textAnchor="middle" fill="#e8edf5" fontSize="16" fontWeight="bold">{readiness}</text>
              </svg>
              <div>
                <div style={{ fontSize: 13, color: readinessColor, fontWeight: 700 }}>{readinessLabel}</div>
                <div style={{ fontSize: 12, color: "#9aa7c2", marginTop: 4 }}>out of 100</div>
          ...
          <div style={styles.metricCard}>
            ...
            {stats?.latestTestScore !== null ? (
              <div style={styles.metricRow}>
                <div style={{ fontSize: 42, fontWeight: 800, color: stats.latestTestScore >= 70 ? "#22c55e" : "#f59e0b" }}>
                  {stats.latestTestScore}%
                </div>
                <div>
                  <div style={{ fontSize: 13, color: "#b6c2d6" }}>{stats.latestTestDomain || "General"}</div>
              ...
              <div style={styles.emptyMetric}>
                ...
                <div style={{ fontSize: 13, color: "#9aa7c2", margin: "8px 0" }}>No tests taken yet</div>
          ...
          <div style={styles.metricCard}>
            ...
            {stats?.topJob ? (
              <div>
                ...
                <div style={{ fontSize: 12, color: "#9aa7c2", marginBottom: 8 }}>
                  {stats.topJob.company}
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <span style={{ ...styles.matchBadge, background: "#22c55e20", color: "#22c55e", border: "1px solid #22c55e40" }}>
              ...
              <div style={styles.emptyMetric}>
                <span style={{ fontSize: 28 }}>🎯</span>
                <div style={{ fontSize: 13, color: "#9aa7c2", margin: "8px 0" }}>Upload resume first</div>
          ...
          <div style={styles.metricCard}>
            ...
            {stats?.roadmapGoal ? (
              <div>
                <div style={{ fontSize: 14, fontWeight: 600, color: "#e8edf5", marginBottom: 4 }}>
                  {stats.roadmapGoal}
                </div>
                <div style={{ fontSize: 12, color: "#9aa7c2" }}>
              ...
              <div style={styles.emptyMetric}>
                ...
                <div style={{ fontSize: 13, color: "#9aa7c2", margin: "8px 0" }}>No roadmap yet</div>
        ...
        <div style={styles.section}>
          ...
          <p style={{ color: "#9aa7c2", fontSize: 14, marginBottom: 24 }}>
        ...
        {!stats?.hasResume && (
          <div style={styles.alertCard}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 700, color: "#e8edf5", marginBottom: 4 }}>
                Start your career intelligence journey
              </div>
              <div style={{ color: "#b6c2d6", fontSize: 13 }}>
...
const styles = {
  ...
  h1: { margin: 0, fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#eef2f8", fontWeight: 800 },
  ...
  metricLabel: { fontSize: 12, fontWeight: 600, color: "#9aa7c2", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 14 },
  ...
  pipelineLabel: { fontSize: 13, fontWeight: 700, color: "#e8edf5", marginBottom: 4 },
  pipelineDesc: { fontSize: 11, color: "#9aa7c2", marginBottom: 8 },
  pipelineArrow: { fontSize: 16, fontWeight: 700 },
  pipelineConnector: { fontSize: 14, color: "#1b2740", flexShrink: 0 },
  alertCard: {
    display: "flex", alignItems: "center", gap: 16,
    padding: "20px 24px", background: "linear-gradient(135deg, rgba(139,92,246,0.08), rgba(45,212,191,0.08))",
    border: "1px solid rgba(139,92,246,0.2)", borderRadius: 14, flexWrap: "wrap",
  },
