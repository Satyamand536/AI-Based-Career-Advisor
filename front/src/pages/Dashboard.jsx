...
const PIPELINE_STEPS = [
  { icon: "🧠", label: "Profile Intelligence", desc: "Resume + Skill Graph", path: "/profile", color: "#818cf8" },
  { icon: "🎯", label: "Tech Job Match",        desc: "Top 10 matched jobs",  path: "/jobs",    color: "#38bdf8" },
    ...
    <div style={layout.page}>
      ...
      <main style={layout.main}>
        <div style={styles.loadingCenter}>
          ...
          <p style={{ color: "#64748b", marginTop: 12 }}>Loading your career intelligence...</p>
        </div>
      </main>
    </div>
  );
        ...
        <div style={styles.metricsGrid}>
          ...
          <div style={{ ...styles.metricCard, border: `1px solid ${readinessColor}30` }}>
            ...
            <div style={styles.metricRow}>
              <svg width={72} height={72} viewBox="0 0 72 72">
                <circle cx="36" cy="36" r="30" fill="none" stroke="#1e293b" strokeWidth="8" />
                <circle
                  cx="36" cy="36" r="30"
                  fill="none"
                ...
                />
                <text x="36" y="41" textAnchor="middle" fill="#e2e8f0" fontSize="16" fontWeight="bold">{readiness}</text>
              </svg>
              <div>
          ...
          <div style={styles.metricCard}>
            ...
            {stats?.latestTestScore !== null ? (
              <div style={styles.metricRow}>
                ...
                <div>
                  <div style={{ fontSize: 13, color: "#94a3b8" }}>{stats.latestTestDomain || "General"}</div>
              ...
              <div style={styles.emptyMetric}>
                ...
                <div style={{ fontSize: 13, color: "#64748b", margin: "8px 0" }}>No tests taken yet</div>
          ...
          <div style={styles.metricCard}>
            ...
            {stats?.topJob ? (
              ...
              <div style={styles.emptyMetric}>
                <span style={{ fontSize: 28 }}>🎯</span>
                <div style={{ fontSize: 13, color: "#64748b", margin: "8px 0" }}>Upload resume first</div>
          ...
          <div style={styles.metricCard}>
            ...
            {stats?.roadmapGoal ? (
              ...
              <div style={styles.emptyMetric}>
                ...
                <div style={{ fontSize: 13, color: "#64748b", margin: "8px 0" }}>No roadmap yet</div>
...
const styles = {
  ...
  h1: { margin: 0, fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#f1f5f9", fontWeight: 800 },
  ...
  metricLabel: { fontSize: 12, fontWeight: 600, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 14 },
  ...
  pipelineLabel: { fontSize: 13, fontWeight: 700, color: "#e2e8f0", marginBottom: 4 },
  pipelineDesc: { fontSize: 11, color: "#64748b", marginBottom: 8 },
  pipelineArrow: { fontSize: 16, fontWeight: 700 },
  pipelineConnector: { fontSize: 14, color: "#334155", flexShrink: 0 },
  alertCard: {
    display: "flex", alignItems: "center", gap: 16,
    padding: "20px 24px", background: "linear-gradient(135deg, rgba(129,140,248,0.08), rgba(56,189,248,0.08))",
    border: "1px solid rgba(129,140,248,0.2)", borderRadius: 14, flexWrap: "wrap",
  },
